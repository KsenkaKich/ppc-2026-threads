...
namespace vinyaikina_e_multidimensional_integrals_simpson_method {
  namespace {
    ...
    double count(double simpson_factor, std::vector<std::pair<double, double>> &limits, std::vector<double>& actual_step, std::function<double(const std::vector<double> &)> function) {
